...
val create_producer : string -> Dwarf_attribute_values.Attribute_value.t
...
val create_stmt_list :
  debug_line_label:Asm_label.t -> Dwarf_attribute_values.Attribute_value.t
...
val create_call_all_calls : unit -> Dwarf_attribute_values.Attribute_value.t
...
val create_location :
  Location_list_table.Index.t -> Dwarf_attribute_values.Attribute_value.t

val create_ranges :
  Range_list_table.Index.t -> Dwarf_attribute_values.Attribute_value.t
...
val create_composite_location_description :
  Composite_location_description.t -> Dwarf_attribute_values.Attribute_value.t
...
val create_inline : Inline_code.t -> Dwarf_attribute_values.Attribute_value.t

val create_call_origin :
  die_symbol:Asm_symbol.t -> Dwarf_attribute_values.Attribute_value.t

val create_abstract_origin :
  die_symbol:Asm_symbol.t -> Dwarf_attribute_values.Attribute_value.t

val create_language :
  Dwarf_language.t -> Dwarf_attribute_values.Attribute_value.t
...
val create_ocaml_compiler_version :
  string -> Dwarf_attribute_values.Attribute_value.t

val create_ocaml_unit_name : Ident.t -> Dwarf_attribute_values.Attribute_value.t
...
val create_ocaml_linker_dirs :
  Misc.Stdlib.String.Set.t -> Dwarf_attribute_values.Attribute_value.t
